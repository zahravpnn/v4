...
cd /usr/bin
# menu
wget -O menu "https://raw.githubusercontent.com/zahravpnn/v4/main/menu/menu.sh"
...
wget -O menu-backup "https://raw.githubusercontent.com/Andyyuda/v4/main/backup/menu-backup.sh"
